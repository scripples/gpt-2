...
parser.add_argument('--sample_every', metavar='N', type=int, default=3, help='Generate samples every N steps')
parser.add_argument('--sample_length', metavar='TOKENS', type=int, default=48, help='Sample this many tokens')
